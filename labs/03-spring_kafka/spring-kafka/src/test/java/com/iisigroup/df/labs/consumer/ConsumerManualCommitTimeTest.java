...
@MySpringBootTest
public class ConsumerManualCommitTimeTest {
    @DynamicPropertySource
    public static void setup(DynamicPropertyRegistry registry) {
        registry.add("spring_kafka_listener_ack_mode", () -> ContainerProperties.AckMode.TIME);
    ...
    // 一次處理一筆
    @KafkaListener(topics = TEST_TOPIC, groupId = "ConsumerManualCommitTimeTest.listen2")
