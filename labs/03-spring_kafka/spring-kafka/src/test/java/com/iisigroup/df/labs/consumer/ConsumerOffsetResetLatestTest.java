...
@MySpringBootTest
public class ConsumerOffsetResetLatestTest {
    @DynamicPropertySource
    public static void setup(DynamicPropertyRegistry registry) {
        registry.add("spring_kafka_consumer_auto_offset_reset", () -> "latest");
    ...
    @KafkaListener(topics = TEST_TOPIC, groupId = "ConsumerOffsetResetLatestTest")
