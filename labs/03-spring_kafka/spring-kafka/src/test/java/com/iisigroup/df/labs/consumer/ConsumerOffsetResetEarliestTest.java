...
@MySpringBootTest
public class ConsumerOffsetResetEarliestTest {
    @DynamicPropertySource
    public static void setup(DynamicPropertyRegistry registry) {
        registry.add("spring_kafka_consumer_auto_offset_reset", () -> "earliest");
    ...
    @KafkaListener(topics = TEST_TOPIC, groupId = "ConsumerOffsetResetEarliestTest")
