...
@MySpringBootTest
public class ConsumerGroupRoundRobinPartitionAssignStrategyTest {

    @DynamicPropertySource
    public static void setup(DynamicPropertyRegistry registry) {
        registry.add("spring.kafka.consumer.properties.partition.assignment.strategy", RoundRobinAssignor.class::getName);
    ...
    @KafkaListener(topics = TEST_TOPIC, groupId = "ConsumerGroupRoundRobinPartitionAssignStrategyTest")
