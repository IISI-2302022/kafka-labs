...
@MySpringBootTest
public class ConsumerOffsetResetNoneTest {
    @DynamicPropertySource
    public static void setup(DynamicPropertyRegistry registry) {
        registry.add("spring_kafka_consumer_auto_offset_reset", () -> "none");
    ...
    @KafkaListener(topics = TEST_TOPIC, groupId = "ConsumerOffsetResetNoneTest")
