...
@MySpringBootTest
public class ConsumerManualCommitRecordTest {

    @DynamicPropertySource
    public static void setup(DynamicPropertyRegistry registry) {
        // 目前預設是 batch 且 auto commit false
        registry.add("spring_kafka_listener_ack_mode", () -> ContainerProperties.AckMode.RECORD);
    ...
    // 一次處理一筆
    @KafkaListener(topics = TEST_TOPIC, groupId = "ConsumerManualCommitRecordTest.listen2")
