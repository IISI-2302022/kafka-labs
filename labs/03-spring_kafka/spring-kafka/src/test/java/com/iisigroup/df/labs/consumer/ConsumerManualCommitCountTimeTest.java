...
@MySpringBootTest
public class ConsumerManualCommitCountTimeTest {
    @DynamicPropertySource
    public static void setup(DynamicPropertyRegistry registry) {
        registry.add("spring_kafka_listener_ack_mode", () -> ContainerProperties.AckMode.COUNT_TIME);
    ...
    // 一次處理一筆
    @KafkaListener(topics = TEST_TOPIC, groupId = "ConsumerManualCommitCountTimeTest.listen2")
